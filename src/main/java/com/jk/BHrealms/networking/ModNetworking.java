package com.jk.BHrealms.networking;
...
public class ModNetworking {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder.named(new ResourceLocation(BHrealms.MODID, "messages"))
        ...
        net.messageBuilder(ClassDataSyncS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(ClassDataSyncS2CPacket::new)
